...
public class JobsDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        // _categories.Add(new Category { Name = "Pending", CategoryId = Guid.Parse("9b2ee223-763a-486a-b04d-2d0203e1e714"), Weight= 20 });
        // _categories.Add(new Category { Name = "Personal", CategoryId = Guid.Parse("f15d905a-ffd8-4f44-b63c-22234605f353"), Weight= 20 });
